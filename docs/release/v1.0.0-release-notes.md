...
To everyone who tested the beta, reported bugs, suggested features and sat through the 28 breaking-change release notes between 0.9 and 1.0 — this release is what you made it. Special thanks to the anonymous pentester who hammered the auth surface hard enough to find the invitation-token entropy issue.

If TravStats ends up useful to you, the nicest ways to say thanks are:
