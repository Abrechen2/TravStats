# TravStats · Web-Redesign — Export

Stand: 2026-09-15 (Runde 4 · Handoff-Vereinheitlichung · Owner-Entscheidungen 1–5 umgesetzt · Statistik: alle vier Domänen-Tabs) · 52 Screens (HTML) · Tokens · Dokumentation

## Öffnen
Jede `*.dc.html` läuft direkt im Browser (Doppelklick oder über einen lokalen Webserver, z. B. `npx serve .`).
Einstieg: **Index.dc.html** (Übersicht aller Screens) oder **Anmelden.dc.html** → **Dashboard.dc.html**.

## Inhalt
- `*.dc.html` — alle Screens, untereinander verlinkt (Kopfleiste, Menü „Mehr“, Profilmenü, Detail-Links)
- `ts-shared.js` — gemeinsame Tokens (T), Domänen, Navigationsmodell, Erfolgsdaten, Lucide-Sprite
- `support.js` — Laufzeit der Seiten (nicht bearbeiten)
- `assets/` — echtes TravStats-Logo (logo.png/svg), Favicon
- `design/tokens.json` — Farb-/Typo-/Abstands-Tokens
- `DESIGN_SYSTEM.md` — Bausteine und Regeln
- `antwort-runde-4.md` — Entscheidungsprotokoll, Umsetzungsliste, Token-Abgleich (enthält Runde 1–3)
- `ROUTENMATRIX.csv` + `Matrix.dc.html` — Routen-/Zustandsmatrix (gestaltet · Prototyp · bestehend · neu nötig)
- `Komponenten.dc.html`, `Vergleich.dc.html`, `Kartenfarben.dc.html` — Komponentenübersicht, Vergleichstafeln, Kartenfarben-Varianten
- Tastatur: ⌘K Suche · g d/l/r/s · n · ? · EN-Fassungen: `EN *.dc.html`
- `MOTION.md` — Bewegungs-Tokens und -Regeln
- Zustände: Wähler unten links auf den Kernseiten oder `#z=leer|filter|laden|fehler|beta`; Mobil: Fenster < 640 px
- `pages/` — frühe Body/Logic-Auszüge (Referenz)
...
- Checkliste.dc.html
- Dashboard.dc.html
- Design Primitives.dc.html
- Dialoge.dc.html
- Druckansicht.dc.html
- EN Logbook Flights.dc.html
- EN Passport.dc.html
- EN Settings.dc.html
- Einrichtung.dc.html
- Einstellungen v2.dc.html
- Einstellungen v3.dc.html
- Einstellungen.dc.html
- Erfolg Detail.dc.html
- Erfolge.dc.html
- Flug Detail.dc.html
- Flugzeug.dc.html
- Globus.dc.html
- Hinzufuegen.dc.html
- Import-Logbuch.dc.html
- Index.dc.html
- Jahresrueckblick.dc.html
- Kartenfarben.dc.html
- Kette Detail.dc.html
- Komponenten.dc.html
- Kreuzfahrt Detail.dc.html
- Liste Detail.dc.html
- Logbuch Domaenen.dc.html
- Logbuch Fluege.dc.html
- Matrix.dc.html
- Mitreisende.dc.html
- Nicht gefunden.dc.html
- Ort Detail.dc.html
- Ortslisten.dc.html
- Parser.dc.html
- Passwort.dc.html
- Posteingang.dc.html
- Registrieren.dc.html
- Reise Detail.dc.html
- Reisen.dc.html
- Reisepass v2.dc.html
- Reisepass.dc.html
- Routeneditor.dc.html
- Statistik.dc.html
- Suche.dc.html
- Tags.dc.html
- Touren-Editor.dc.html
- Unterkunft Detail.dc.html
- Vergleich.dc.html

## Owner-Entscheidungen 15.09. (umgesetzt)
- Kartenfarben Variante 2 (Domänenfarbe + geplant 55 % gestrichelt) · Einstellungen als Routen `/settings/:group` · Erfolge unter Statistik · Tags & Mitreisende für alle vier Domänen · Jahresrückblick-PNG serverseitig. Details: `antwort-runde-4.md` §6.

## Hinweise
- Alle Daten sind Beispieldaten; Struktur und Begriffe folgen `frontend/src/i18n/resources/de/*.json` des Repos.
- Verlinkungen zwischen Screens sind relativ — Ordnerstruktur beibehalten.
- Einstellungen: aktuelle Fassung ist **Einstellungen v3**, Admin: **Admin v2**, Reisepass: **Reisepass v2** (ältere Fassungen bleiben zum Vergleich enthalten).
