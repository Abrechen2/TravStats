...
export const NAV = {
  ...
  more: [
    { group:'Sammlungen', items:[ { id:'achievements', label:'Erfolge', icon:'trophy', href:'Erfolge.dc.html', meta:'83' }, { id:'passport', label:'Reisepass', icon:'book-open', href:'Reisepass v2.dc.html', meta:'52 Länder' }, { id:'lists', label:'Ortslisten', icon:'list', href:'Ortslisten.dc.html', meta:'6' } ] },
  ...
  profile: [ { id:'companions', label:'Mitreisende', icon:'user', href:'Mitreisende.dc.html' }, { id:'settings', label:'Einstellungen', icon:'settings', href:'Einstellungen v3.dc.html' }, { id:'logout', label:'Abmelden', icon:'log-out', href:'Anmelden.dc.html' } ],
};
