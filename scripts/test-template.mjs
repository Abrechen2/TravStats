...
const PATTERNS = {
  ...
  flightNumber:
    "<https://images\\.booking\\.lufthansa\\.com/Icons/icon_lufthansa\\.jpg>\\s*([A-Z0-9 ]{4,8})",
...
async function extractMsgText(buffer, filename) {
  ...
  const { default: MsgReader } =
    await import("../backend/node_modules/@kenjiuno/msgreader/lib/MsgReader.js");
...
for (const file of files.sort()) {
  ...
  const icon =
    fileMatches === Object.keys(PATTERNS).length ? "PASS" : fileMatches > 0 ? "PARTIAL" : "FAIL";
