...
This project is indexed by GitNexus as **TravStats** (3409 symbols, 8803 relationships, 251 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
