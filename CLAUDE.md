...
This project is indexed by GitNexus as **TravStats** (4490 symbols, 11344 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
