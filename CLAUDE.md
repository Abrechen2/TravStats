...
This project is indexed by GitNexus as **immich-albums** (4889 symbols, 12506 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
