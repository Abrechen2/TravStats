...
This project is indexed by GitNexus as **TravStats** (7612 symbols, 19882 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
