...
This project is indexed by GitNexus as **TravStats** (5812 symbols, 14779 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
