...
This project is indexed by GitNexus as **TravStats** (3459 symbols, 8982 relationships, 255 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
