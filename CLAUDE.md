...
This project is indexed by GitNexus as **TravStats** (4467 symbols, 11290 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
