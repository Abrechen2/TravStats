...
This project is indexed by GitNexus as **TravStats** (2741 symbols, 7010 relationships, 200 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
