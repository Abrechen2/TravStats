...
This project is indexed by GitNexus as **TravStats** (3271 symbols, 8346 relationships, 241 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
