...
This project is indexed by GitNexus as **TravStats** (8757 symbols, 23313 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
