...
This project is indexed by GitNexus as **TravStats** (3257 symbols, 8329 relationships, 239 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
