...
This project is indexed by GitNexus as **TravStats** (7125 symbols, 18276 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
