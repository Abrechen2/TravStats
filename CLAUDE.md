...
This project is indexed by GitNexus as **session-boot** (5483 symbols, 14272 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
