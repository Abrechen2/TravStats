...
This project is indexed by GitNexus as **TravStats** (7123 symbols, 18261 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
