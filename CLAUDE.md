...
This project is indexed by GitNexus as **TravStats** (3421 symbols, 8839 relationships, 252 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
