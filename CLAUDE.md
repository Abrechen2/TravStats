...
This project is indexed by GitNexus as **TravStats** (6576 symbols, 16788 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
