      ...
      .mockResolvedValueOnce([
        {
          ...
          arrLat: 40,
          arrLon: -73,
          departureTime: new Date("2025-03-10T00:00:00Z"),
          arrivalTime: null,
          depTimeSemantics: "LOCAL",
          arrTimeSemantics: "LOCAL",
        },
      ])
      ...
      .mockResolvedValueOnce([
        {
          ...
          legs: [{ distanceKm: 300 }, { distanceKm: 200 }],
        },
      ])
      .mockResolvedValueOnce([]);
    const res = await request(app).get(
    ...
    mockFlightFindMany.mockResolvedValue([
      {
        ...
        arrLat: 40,
        arrLon: -73,
        departureTime: new Date("2024-06-10T00:00:00Z"),
        arrivalTime: null,
        depTimeSemantics: "LOCAL",
        arrTimeSemantics: "LOCAL",
      },
