...
router.get('/smtp', authenticate, requireAdmin, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.put('/smtp', authenticate, requireAdmin, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post('/smtp/test', authenticate, requireAdmin, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const data = smtpConfigSchema.parse(req.body);
