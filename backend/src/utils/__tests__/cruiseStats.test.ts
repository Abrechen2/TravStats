    ...
    const cruises: CruiseData[] = [
      {
        ...
        endDate: null,
        stops: [
          { portId: 1, port: port(1, "alaska", "United States"), dayNumber: 1, isAtSea: false },
        ],
      },
    ];
    const s = calculateCruiseStats(cruises);
  ...
  it("buckets each cruise's countries under its start year", () => {
    const cruises: CruiseData[] = [
      ...
      },
      {
        ...
        startDate: new Date("2026-08-01"),
        endDate: new Date("2026-08-08"),
        stops: [{ portId: 3, port: port(3, "caribbean", "Bahamas"), dayNumber: 1, isAtSea: false }],
      },
    ];
    const s = calculateCruiseStats(cruises);
    expect([...(s.countriesByYear.get(2026) ?? [])].sort()).toEqual(["Bahamas", "France", "Spain"]);
  });
    ...
    const cruises: CruiseData[] = [
      {
        ...
        stops: [{ portId: 1, port: port(1, "baltic", "Norway"), dayNumber: 1, isAtSea: false }],
      },
      {
        id: "b",
        shipId: 1,
        ...
        stops: [{ portId: 2, port: port(2, "caribbean", "Aruba"), dayNumber: 1, isAtSea: false }],
      },
    ];
    const s = calculateCruiseStats(cruises);
    ...
    const cruises: CruiseData[] = [
      {
        ...
        startDate: null,
        endDate: null,
        stops: [{ portId: 1, port: port(1, "baltic", "Estonia"), dayNumber: 1, isAtSea: false }],
      },
    ];
    const s = calculateCruiseStats(cruises);
