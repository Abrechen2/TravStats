...
/**
 * Truth table for the four precisions. Mirrored in
 * `frontend/src/shared/__tests__/lodgingTiming.test.ts` — change one side alone
 * and the two disagree here first.
 */
