...
export const BULK_CITIES: BulkCity[] = [
  {
    ...
    country: "Austria",
    iso: "AT",
    hotel: { name: "Hotel Sacher", type: "hotel", stars: 5, lat: 48.2038, lon: 16.3694, year: 2019, nights: 2, price: 690, currency: "EUR", rating: 5 },
    places: [
  ...
  },
  {
    ...
    country: "Czechia",
    iso: "CZ",
    hotel: { name: "Hotel Josef", type: "hotel", stars: 4, lat: 50.0901, lon: 14.4236, year: 2018, nights: 3, price: 420, currency: "EUR", rating: 4 },
    places: [
  ...
  },
  {
    ...
    country: "France",
    iso: "FR",
    hotel: { name: "Hôtel des Grands Boulevards", type: "hotel", stars: 4, lat: 48.8713, lon: 2.3467, year: 2022, nights: 3, price: 810, currency: "EUR", rating: 4.5 },
    places: [
  ...
  },
  {
    ...
    iso: "GB",
    hotel: { name: "The Hoxton Southwark", type: "hotel", stars: 4, lat: 51.5049, lon: -0.1052, year: 2023, nights: 4, price: 980, currency: "GBP", rating: 4 },
    places: [
  ...
  },
  {
    ...
    country: "Netherlands",
    iso: "NL",
    hotel: { name: "Pulitzer Amsterdam", type: "hotel", stars: 5, lat: 52.3729, lon: 4.8836, year: 2021, nights: 2, price: 740, currency: "EUR", rating: 4.5 },
    places: [
  ...
  },
  {
    ...
    country: "Denmark",
    iso: "DK",
    hotel: { name: "Generator Copenhagen", type: "hostel", stars: null, lat: 55.6842, lon: 12.5877, year: 2017, nights: 3, price: 210, currency: "DKK", rating: 3.5 },
    places: [
  ...
  },
  {
    ...
    country: "Sweden",
    iso: "SE",
    hotel: { name: "Hotel Skeppsholmen", type: "hotel", stars: 4, lat: 59.3257, lon: 18.0842, year: 2022, nights: 3, price: 5400, currency: "SEK", rating: 4 },
    places: [
  ...
  },
  {
    ...
    country: "United Kingdom",
    iso: "GB",
    hotel: { name: "Old Town Apartment", type: "apartment", stars: null, lat: 55.9496, lon: -3.1904, year: 2019, nights: 4, price: 640, currency: "GBP", rating: 4 },
    places: [
  ...
  },
  {
    ...
    country: "Portugal",
    iso: "PT",
    hotel: { name: "Casa do Bairro", type: "guesthouse", stars: null, lat: 38.7136, lon: -9.1445, year: 2018, nights: 3, price: 330, currency: "EUR", rating: 4.5 },
    places: [
  ...
  },
  {
    ...
    country: "Spain",
    iso: "ES",
    hotel: { name: "Hotel Urban", type: "hotel", stars: 5, lat: 40.4152, lon: -3.6989, year: 2020, nights: 2, price: 460, currency: "EUR", rating: 4 },
    places: [
  ...
  },
  {
    ...
    iso: "US",
    hotel: { name: "The Standard High Line", type: "hotel", stars: 4, lat: 40.7408, lon: -74.0079, year: 2019, nights: 5, price: 2100, currency: "USD", rating: 4 },
    places: [
  ...
  },
  {
    ...
    country: "United States",
    iso: "US",
    hotel: { name: "Hotel Zephyr", type: "hotel", stars: 3, lat: 37.8078, lon: -122.4149, year: 2019, nights: 3, price: 890, currency: "USD", rating: 3.5 },
    places: [
  ...
  },
  {
    ...
    country: "Singapore",
    iso: "SG",
    hotel: { name: "Hotel Indigo Katong", type: "hotel", stars: 4, lat: 1.3052, lon: 103.9048, year: 2023, nights: 3, price: 980, currency: "SGD", rating: 4.5 },
    places: [
  ...
  },
  {
    ...
    country: "Thailand",
    iso: "TH",
    hotel: { name: "Riva Arun", type: "hotel", stars: 4, lat: 13.7437, lon: 100.4899, year: 2018, nights: 3, price: 14500, currency: "THB", rating: 4 },
    places: [
  ...
  },
  {
    ...
    country: "Australia",
    iso: "AU",
    hotel: { name: "QT Sydney", type: "hotel", stars: 5, lat: -33.8712, lon: 151.2073, year: 2020, nights: 4, price: 1650, currency: "AUD", rating: 4.5 },
    places: [
  ...
  },
  {
    ...
    iso: "ZA",
    hotel: { name: "Cape Heritage Hotel", type: "hotel", stars: 4, lat: -33.9176, lon: 18.4199, year: 2022, nights: 4, price: 12800, currency: "ZAR", rating: 4.5 },
    places: [
  ...
  },
  {
    ...
    country: "Morocco",
    iso: "MA",
    hotel: { name: "Riad Kniza", type: "guesthouse", stars: null, lat: 31.6343, lon: -7.9941, year: 2017, nights: 3, price: 480, currency: "EUR", rating: 5 },
    places: [
  ...
  },
  {
    ...
    iso: "AE",
    hotel: { name: "Rove Downtown", type: "hotel", stars: 3, lat: 25.1932, lon: 55.2796, year: 2021, nights: 2, price: 1100, currency: "AED", rating: 3.5 },
    places: [
  ...
  },
  {
    ...
    country: "Germany",
    iso: "DE",
    hotel: { name: "Michelberger Hotel", type: "hotel", stars: 3, lat: 52.5069, lon: 13.4466, year: 2024, nights: 2, price: 260, currency: "EUR", rating: 4 },
    places: [
  ...
  },
  {
    ...
    country: "Germany",
    iso: "DE",
    hotel: { name: "25hours Hotel HafenCity", type: "hotel", stars: 4, lat: 53.5429, lon: 9.9967, year: 2025, nights: 2, price: 310, currency: "EUR", rating: 4.5 },
    places: [
