 ...
 *
 * MIRRORED from `backend/src/shared/lodgingSpendConverted.ts`. Nothing checks
 * that the two sides agree — each has its own test of the same truth table,
 * which is the convention here, not a guard. Change both together.
 */
