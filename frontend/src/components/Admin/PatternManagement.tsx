      ...
      <div className="bg-[var(--bg-surface)] rounded-lg shadow p-6">
        ...
        {patternData ? (
          <div className="space-y-6">
            ...
            {patternData.stats && (
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <div className="text-blue-600 text-sm font-medium mb-1">Total Patterns</div>
                  <div className="text-2xl font-bold text-blue-900">{patternData.stats.total}</div>
                </div>
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  <div className="text-green-600 text-sm font-medium mb-1">Applied</div>
                ...
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                  <div className="text-purple-600 text-sm font-medium mb-1">Avg Confidence</div>
            ...
            <div className="bg-[var(--bg-base)] rounded-lg p-6">
              ...
              {patternData.pendingSuggestions && patternData.pendingSuggestions.length > 0 ? (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="mb-2">
                            <span className="text-sm text-[var(--text-muted)]">Pattern: </span>
                          ...
                          {suggestion.examples && suggestion.examples.length > 0 && (
                            <div>
                              <span className="text-sm text-[var(--text-muted)]">Examples: </span>
                              <span className="text-sm text-[var(--text-primary)]">
                ...
                <p className="text-[var(--text-muted)]">No pending pattern suggestions</p>
              )}
            </div>
            ...
            {patternData.summary && (
              <div className="bg-[var(--bg-base)] rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    <span className="text-[var(--text-muted)]">Pattern Suggestions:</span>
                    <span className="font-medium text-[var(--text-primary)]">
          ...
          <div className="text-center py-12">
            <div className="text-[var(--text-muted)] mb-2">Loading pattern data...</div>
          </div>
        )}
      </div>
      ...
      {showPatternConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[var(--bg-surface)] rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
            <h3 className="text-xl font-bold text-[var(--text-primary)] mb-4">Pattern anwenden?</h3>
