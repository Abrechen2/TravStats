        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <select
              ...
              onChange={(e) => onLoggingConfigChange({ ...loggingConfig, logLevel: e.target.value })}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => onLoggingConfigChange({ ...loggingConfig, logRetentionDays: parseInt(e.target.value) })}
              className="w-full px-3 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white"
            />
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
        ...
        <div className="space-y-3">
          <label className="flex items-start gap-3">
            <input
              ...
              onChange={(e) => onLoggingConfigChange({ ...loggingConfig, logHttpRequests: e.target.checked })}
          ...
          <label className="flex items-start gap-3">
            <input
              ...
              onChange={(e) => onLoggingConfigChange({ ...loggingConfig, logDatabaseQueries: e.target.checked })}
              className="mt-1 h-4 w-4"
            />
            <div>
          ...
          <label className="flex items-start gap-3">
            <input
              ...
              onChange={(e) => onLoggingConfigChange({ ...loggingConfig, logParserOperations: e.target.checked })}
              className="mt-1 h-4 w-4"
            />
            <div>
