        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => onTrainingConfigChange({ ...trainingConfig, trainingModelOutputDir: e.target.value })}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => onTrainingConfigChange({ ...trainingConfig, trainingEmailModelName: e.target.value })}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => onTrainingConfigChange({ ...trainingConfig, trainingVisionModelName: e.target.value })}
