  ...
  render(
    <TimeCell
      flight={
        {
          ...base,
          departureTime: "2026-05-02T19:40:00Z",
          arrivalTime: "2026-05-03T02:45:00Z",
          depTimezone: "Europe/Berlin",
          arrTimezone: "Asia/Dubai",
  ...
  render(
    <TimeCell
      flight={
        {
          ...base,
          departureTime: "2026-05-02T12:00:00Z",
          arrivalTime: "2026-05-02T12:00:00Z",
  ...
  render(
    <TimeCell
      flight={
        {
          ...base,
          departureTime: "2026-09-09T14:25:00Z",
          arrivalTime: "2026-09-09T18:00:00Z",
          depTimezone: "Europe/Berlin",
          arrTimezone: null,
        } as unknown as Flight
      }
      ...
      flight={
        {
          ...base,
          departureTime: "2026-09-09T14:25:00Z",
          arrivalTime: "2026-09-09T16:25:00Z",
          depTimezone: null,
          arrTimezone: null,
        } as unknown as Flight
      }
...
it("shows a late actual departure next to the scheduled one", () => {
  render(
    <TimeCell
      flight={{ ...withActuals, actualDeparture: "2026-08-13T05:31:00Z" } as unknown as Flight}
    />
  );
...
it("colours a late actual time as a delay and an early one as a gain", () => {
  ...
  render(
    <TimeCell
      flight={{ ...withActuals, actualArrival: "2026-08-13T06:28:00Z" } as unknown as Flight}
    />
  );
...
it("renders an actual time that matches the schedule as neither late nor early", () => {
  ...
  const { container } = render(
    <TimeCell
      flight={{ ...withActuals, actualDeparture: "2026-08-13T05:25:00Z" } as unknown as Flight}
    />
  );
      ...
      flight={
        {
          ...base,
          departureTime: "2026-05-02T12:00:00Z",
          arrivalTime: "2026-05-02T15:00:00Z",
          depTimezone: "Europe/Berlin",
          arrTimezone: "Europe/Berlin",
          depTimeSemantics: "DATE_ONLY",
