      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b dark:border-gray-700">
        <div className="px-4 xl:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 xl:gap-4">
            ...
            <Link
              to="/import"
              className="hidden xl:flex px-3 xl:px-4 py-2 text-sm font-medium text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-colors"
            >
              📧 Email Import
            </Link>
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div className="space-y-3">
                ...
                <Link
                  to="/import"
                  onClick={() => setNavOpen(false)}
                  className="flex items-center gap-3 px-4 py-3 text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-gray-700 rounded-lg font-semibold transition-colors"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
