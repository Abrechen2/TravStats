    ...
    <AppShell width="list">
      ...
      <div className="space-y-8">
        {Object.entries(groupedAchievements).map(([category, categoryAchievements]) => {
          const hiddenInCategory = categoryAchievements.filter((a) => a.isHidden && !a.isUnlocked);
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        background: "var(--bg-surface)",
                        border: "1px solid var(--color-border)",
                        boxShadow: achievement.isUnlocked ? "0 0 12px var(--accent-glow)" : "none",
                    ...
                    >
                      <div className="p-6">
                        <div className="flex items-start justify-between mb-3">
                          <div className="text-4xl">{isMystery ? "❔" : achievement.icon}</div>
                          <div
