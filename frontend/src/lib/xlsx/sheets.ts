...
export function flightSheet(t: T): SheetSpec<Flight> {
  return {
    ...
    columns: [
      ...
      {
        key: "flightNumber",
        header: t("xlsx:columns.flightNumber"),
        kind: "text",
        width: 12,
      ...
      {
        key: "departureTime",
        header: t("xlsx:columns.departure"),
        kind: "datetime",
        width: 18,
      ...
      {
        key: "aircraft",
        header: t("xlsx:columns.aircraft"),
        kind: "text",
        width: 18,
      ...
      },
      {
        ...
        header: t("xlsx:columns.registration"),
        kind: "text",
        width: 12,
      ...
      {
        key: "seatClass",
        header: t("xlsx:columns.seatClass"),
        kind: "text",
        width: 16,
      ...
      },
      {
        ...
        header: t("xlsx:columns.bookingReference"),
        kind: "text",
        width: 14,
      ...
      {
        key: "category",
        header: t("xlsx:columns.category"),
        kind: "text",
        width: 12,
...
export function cruiseSheet(t: T): SheetSpec<Cruise> {
  return {
    ...
    columns: [
      ...
      {
        key: "cruiseLine",
        header: t("xlsx:columns.cruiseLine"),
        kind: "text",
        width: 22,
      ...
      {
        key: "routeName",
        header: t("xlsx:columns.routeName"),
        kind: "text",
        width: 26,
        value: (c) => c.routeName,
      },
      ...
      {
        key: "arrivalPort",
        header: t("xlsx:columns.arrivalPort"),
        kind: "text",
        width: 20,
      ...
      {
        key: "cabinNumber",
        header: t("xlsx:columns.cabinNumber"),
        kind: "text",
        width: 12,
      ...
      {
        key: "cabinType",
        header: t("xlsx:columns.cabinType"),
        kind: "text",
        width: 14,
        value: (c) => c.cabinType,
      },
...
export function cruiseStopSheet(t: T): SheetSpec<CruiseStopRow> {
  return {
    ...
    columns: [
      ...
      {
        key: "dayNumber",
        header: t("xlsx:columns.dayNumber"),
        kind: "number",
        width: 8,
        value: (s) => s.dayNumber,
      },
      ...
      {
        key: "arrivalTime",
        header: t("xlsx:columns.arrivalTime"),
        kind: "text",
        width: 12,
      ...
      {
        key: "departureTime",
        header: t("xlsx:columns.departureTime"),
        kind: "text",
        width: 12,
      ...
      {
        key: "excursionNote",
        header: t("xlsx:columns.excursionNote"),
        kind: "text",
        width: 34,
...
export function lodgingSheet(t: T): SheetSpec<Lodging> {
  return {
    ...
    columns: [
      ...
      {
        key: "country",
        header: t("xlsx:columns.country"),
        kind: "text",
        width: 16,
        value: (l) => l.country,
      },
      { key: "lat", header: t("xlsx:columns.lat"), kind: "number", width: 12, value: (l) => l.lat },
      { key: "lon", header: t("xlsx:columns.lon"), kind: "number", width: 12, value: (l) => l.lon },
      {
        key: "stars",
        header: t("xlsx:columns.stars"),
        kind: "number",
        width: 8,
        value: (l) => l.stars,
      },
      ...
      {
        key: "amenities",
        header: t("xlsx:columns.amenities"),
        kind: "text",
        width: 26,
...
export function lodgingStaySheet(t: T): SheetSpec<LodgingStayRow> {
  return {
    ...
    columns: [
      ...
      {
        key: "checkOut",
        header: t("xlsx:columns.checkOut"),
        kind: "date",
        width: 14,
        value: (s) => s.checkOut,
      },
      ...
      {
        key: "roomNumber",
        header: t("xlsx:columns.roomNumber"),
        kind: "text",
        width: 12,
      ...
      {
        key: "roomCategory",
        header: t("xlsx:columns.roomCategory"),
        kind: "text",
        width: 16,
      ...
      {
        key: "pricePerNight",
        header: t("xlsx:columns.pricePerNight"),
        kind: "number",
        width: 14,
      ...
      {
        key: "totalPrice",
        header: t("xlsx:columns.totalPrice"),
        kind: "number",
        width: 12,
...
export function placeSheet(t: T, locale = "de"): SheetSpec<Place> {
  return {
    ...
    columns: [
      ...
      { key: "lat", header: t("xlsx:columns.lat"), kind: "number", width: 12, value: (p) => p.lat },
      { key: "lon", header: t("xlsx:columns.lon"), kind: "number", width: 12, value: (p) => p.lon },
      {
        key: "visited",
        header: t("xlsx:columns.visited"),
        kind: "boolean",
